...
// const medBlue = '#4eb8dd';
// const lightBlue =  '#ddf1fa';
// const inputBG = '#f3fafd';
const darkBlue = 'orange';
const medBlue = 'orange';
const lightBlue =  '#fff7e8';
const inputBG = '#fff7e8';
...
form {
  /* position: absolute; top: 50%; left: 50%; transform: translate(-50%,-50%); */
	...
	margin: auto; padding: 2.25em; box-sizing: border-box; border: solid 1px #DDD; border-radius: .5em;
	...
	label {
		...
		font-size: 1.25em; color: ${darkBlue}; font-weight: 700; font-family: inherit;
	}
